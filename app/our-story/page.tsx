...
export default function OurStoryPage() {
  return (
    <div className="min-h-screen bg-[rgb(var(--story-background))] text-[rgb(var(--story-foreground))]">
      <Header />
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-6 animate-story-fade-in">
          ...
          <button className="bg-[rgb(var(--story-primary))] text-[rgb(var(--story-primary-foreground))] px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[rgb(var(--story-secondary))] transition-all duration-300 transform hover:scale-105">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-story-fade-in">
            <h2 className="font-serif text-4xl md:text-5xl font-bold mb-6 text-[rgb(var(--story-foreground))]">
              Our Journey
            </h2>
            <p className="text-xl text-[rgb(var(--story-muted-foreground))] max-w-3xl mx-auto text-pretty">
          ...
          <div className="space-y-16">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 animate-story-slide-in">
              <div className="md:w-1/2">
                <div className="bg-[rgb(var(--story-card))] p-8 rounded-2xl shadow-lg animate-story-card-hover">
                  <div className="flex items-center mb-4">
                    <Calendar className="w-8 h-8 text-[rgb(var(--story-primary))] mr-3" />
                    <span className="text-2xl font-bold text-[rgb(var(--story-primary))]">2018</span>
                  </div>
                  <h3 className="font-serif text-2xl font-bold mb-4">The Beginning</h3>
                  <p className="text-[rgb(var(--story-muted-foreground))] leading-relaxed">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-12 animate-story-slide-in">
              <div className="md:w-1/2">
                <div className="bg-[rgb(var(--story-card))] p-8 rounded-2xl shadow-lg animate-story-card-hover">
                  <div className="flex items-center mb-4">
                    <Award className="w-8 h-8 text-[rgb(var(--story-primary))] mr-3" />
                    <span className="text-2xl font-bold text-[rgb(var(--story-primary))]">2020</span>
                  </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 animate-story-slide-in">
              <div className="md:w-1/2">
                <div className="bg-[rgb(var(--story-card))] p-8 rounded-2xl shadow-lg animate-story-card-hover">
                  <div className="flex items-center mb-4">
                    <Sparkles className="w-8 h-8 text-[rgb(var(--story-primary))] mr-3" />
                    <span className="text-2xl font-bold text-[rgb(var(--story-primary))]">2024</span>
                  </div>
      ...
      {/* Mission Statement */}
      <section className="py-20 bg-[rgb(var(--story-muted))]">
        <div className="max-w-4xl mx-auto text-center px-6 animate-story-fade-in">
          <h2 className="font-serif text-4xl md:text-5xl font-bold mb-8 text-[rgb(var(--story-foreground))]">
            Our Mission
          </h2>
          <blockquote className="text-2xl md:text-3xl font-light italic text-[rgb(var(--story-muted-foreground))] leading-relaxed text-balance">
          ...
          <div className="mt-8 w-24 h-1 bg-[rgb(var(--story-primary))] mx-auto rounded-full"></div>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-[rgb(var(--story-card))] rounded-2xl shadow-lg animate-story-card-hover">
              <Heart className="w-16 h-16 text-[rgb(var(--story-primary))] mx-auto mb-6" />
            ...
            <div className="text-center p-8 bg-[rgb(var(--story-card))] rounded-2xl shadow-lg animate-story-card-hover">
              <Star className="w-16 h-16 text-[rgb(var(--story-primary))] mx-auto mb-6" />
            ...
            <div className="text-center p-8 bg-[rgb(var(--story-card))] rounded-2xl shadow-lg animate-story-card-hover">
              <Users className="w-16 h-16 text-[rgb(var(--story-primary))] mx-auto mb-6" />
      ...
      <section className="py-20 bg-[rgb(var(--story-primary))] bg-opacity-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg animate-story-card-hover">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-[rgb(var(--story-muted-foreground))]">Wedding Clients</p>
                </div>
              </div>
              <blockquote className="text-[rgb(var(--story-muted-foreground))] italic leading-relaxed mb-4">
              ...
              <div className="flex text-[rgb(var(--story-primary))]">
                {[...Array(5)].map((_, i) => (
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg animate-story-card-hover">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-[rgb(var(--story-muted-foreground))]">Corporate Client</p>
                </div>
              </div>
              <blockquote className="text-[rgb(var(--story-muted-foreground))] italic leading-relaxed mb-4">
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center animate-story-fade-in">
          ...
          <p className="text-xl text-[rgb(var(--story-muted-foreground))] mb-8 text-pretty">
            Let us help you craft an unforgettable experience that reflects your unique vision and style.
          </p>
          <button className="bg-[rgb(var(--story-primary))] text-[rgb(var(--story-primary-foreground))] px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[rgb(var(--story-secondary))] transition-all duration-300 transform hover:scale-105 mr-4">
            Start Planning
          </button>
          <button className="border-2 border-[rgb(var(--story-primary))] text-[rgb(var(--story-primary))] px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[rgb(var(--story-primary))] hover:text-[rgb(var(--story-primary-foreground))] transition-all duration-300">
            View Our Portfolio
          </button>
        </div>
      </section>
